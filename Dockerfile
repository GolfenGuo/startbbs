...
RUN sed -i 's#localhost#getenv("MYSQL_PORT_3306_TCP_ADDR")#' app/config/database.php && sed -i 's#root#getenv("MYSQL_USERNAME")#' app/config/database.php && sed -i "s#123456#getenv("MYSQL_PASSWORD")#' app/config/database.php
