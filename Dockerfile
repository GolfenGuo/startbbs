...
RUN sed -i "s#localhost#${MYSQL_PORT_3306_TCP_ADDR}#" app/config/database.php && sed -i "s#root#${MYSQL_USERNAME}" app/config/database.php && sed -i "s#123456#${MYSQL_PASSWORD}" app/config/database.php
